      ...
      <section className="py-20 md:py-32 overflow-hidden border-b border-gray-100 bg-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="mb-12 text-center">
            <span className="inline-block px-4 py-2 bg-brand-green/10 text-brand-green font-bold rounded-full text-sm mb-4">나란히 안심리포트 리얼 후기</span>
                ...
                {carouselCards.map((card, index) => (
                  <div key={index} className="w-full flex-shrink-0 p-8 md:p-14 relative">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      <span className="px-3 py-1.5 bg-gray-100 text-gray-700 font-bold text-xs md:text-sm rounded-md">[{card.tag1}]</span>
                      <span 
                        className={`px-3 py-1.5 font-bold text-xs md:text-sm rounded-md ${
                    ...
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-gray-900 leading-tight mb-8 break-keep relative z-10">
                      "{card.title}"
                    </h3>
      ...
      <section className="py-20 md:py-32 bg-brand-blue text-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14 md:mb-16">
            <span className="inline-block px-4 py-1.5 bg-white/10 text-brand-pink font-bold rounded-full text-xs md:text-sm mb-4">
              실제 제공 리포트 & 실시간 소통
            </span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white tracking-tight break-keep">
              나란히 안심 리포트 & 진행 상황 실시간 보고
            </h2>
            <p className="text-white/80 text-sm md:text-base mt-3 break-keep">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-stretch">
            ...
            >
              <div className="text-left mb-6">
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-2.5 py-1 bg-brand-pink/20 text-brand-pink font-bold rounded-md text-xs">
                    동행 완료 후 전송
                  </span>
                </div>
                <h3 className="text-2xl font-bold text-white mb-2">나란히 안심 리포트</h3>
              ...
              <div className="relative pt-8 pb-4 w-full max-w-[360px] mx-auto h-[620px] flex items-center justify-center">
                ...
                <div className="absolute top-4 -left-2 right-8 bottom-16 bg-white rounded-xl shadow-xl p-5 border border-gray-200 -rotate-[5deg] opacity-95 pointer-events-none">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 space-y-2 text-gray-700 text-[11.5px] leading-relaxed break-keep">
                    <p>
                ...
                <div className="absolute top-[130px] left-6 -right-2 bottom-0 z-10 bg-white rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.2)] p-5 border border-gray-100 flex flex-col text-gray-900">
                  ...
                  <div className="flex flex-col flex-grow relative overflow-hidden">
                    ...
                    <div className="relative flex-grow bg-brand-pink/5 rounded-xl border border-brand-pink/20 shadow-inner overflow-hidden">
                      <div className="absolute inset-0 p-3.5 text-gray-800 text-[11.5px] leading-[1.65] break-keep overflow-y-auto no-scrollbar pb-6">
            ...
            >
              <div className="text-left mb-6">
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-2.5 py-1 bg-green-500/20 text-green-400 font-bold rounded-md text-xs">
                    동행 중 실시간 공유
                  </span>
                </div>
                <h3 className="text-2xl font-bold text-white mb-2">진행 상황 실시간 보고</h3>
                <p className="text-white/70 text-sm break-keep">
      ...
      <section className="py-20 md:py-32 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="mb-12 md:mb-16">
            ...
            <h2 className="text-[20px] md:text-[25px] font-extrabold text-brand-blue tracking-tight mb-3">
            ...
            >
              ...
              <ul className="space-y-8">
                <li className="flex gap-4">
                  ...
                  <div>
                    <strong className="block text-[15px] text-brand-blue mb-1">진료 핵심 요약</strong>
                    <p className="text-brand-blue/70 text-[14px] leading-relaxed">의사 선생님의 핵심 전달 사항과 진료 전반에 관한 사항을 알기 쉽게 정리합니다.</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  <HeartHandshake className="w-6 h-6 text-brand-green flex-shrink-0 mt-1" />
                  <div>
                    <strong className="block text-[15px] text-brand-blue mb-1">진료실 안 대변인</strong>
                    <p className="text-brand-blue/70 text-[14px] leading-relaxed">환자가 미처 말씀하지 못한 평소의 불편함이나 증상을 매니저가 대신 의사에게 전달하고 그 결과를 기록합니다.</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  <Pill className="w-6 h-6 text-brand-green flex-shrink-0 mt-1" />
                  <div>
                    <strong className="block text-[15px] text-brand-blue mb-1">복약 및 다음 일정 가이드</strong>
                    <p className="text-brand-blue/70 text-[14px] leading-relaxed">새로 처방된 약의 용법, 다음 진료 예약 및 검사 전 주의사항(금식 등)을 안내하여 다음 진료를 대비합니다.</p>
                  </div>
                </li>
              </ul>
            </motion.div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div className="w-full">
                      <strong className="block text-[15px] text-brand-blue mb-2">보험 청구 서류 완비</strong>
                      <p className="text-brand-blue/70 mb-3 text-[14px]">실손보험 청구용 맞춤 서류를 꼼꼼히 챙겨드립니다.</p>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <strong className="block text-[15px] text-brand-blue mb-1">원스톱 행정 대행</strong>
                      <p className="text-brand-blue/70 text-[14px]">진료비 결제부터 약국 처방까지 전 과정을 대신 처리해 드립니다.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <strong className="block text-[15px] text-brand-blue mb-1">실시간 사진 증빙</strong>
                      <p className="text-brand-blue/70 text-[14px]">모든 서류와 영수증은 사진으로 선명하게 바로 전송해 드립니다.</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 md:py-32 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-[20px] md:text-[25px] font-extrabold text-brand-blue tracking-tight mb-4 leading-tight">
              일반 동행 안심 리포트 :<br />
              <span className="text-brand-pink">꼼꼼한 일상 기록</span>
            </h2>
            <p className="text-[14px] md:text-[15px] text-brand-blue/80 font-medium mb-10 leading-relaxed break-keep">
            ...
            <div className="space-y-7">
               <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <strong className="block text-[16px] text-brand-blue mb-1">활동 요약</strong>
                    <p className="text-brand-blue/70 text-[14px] md:text-[15px] leading-relaxed break-keep">이동 경로와 주요 활동 내용을 상세히 전달합니다.</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <strong className="block text-[16px] text-brand-blue mb-1">정서 및 컨디션 보고</strong>
                    <p className="text-brand-blue/70 text-[14px] md:text-[15px] leading-relaxed break-keep">어르신의 오늘 기분, 목소리 톤, 나누었던 주요 대화 내용을 기록하여 마음 컨디션까지 공유합니다.</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center flex-shrink-0 shadow-sm border border-gray-100">
                  ...
                  <div>
                    <strong className="block text-[16px] text-brand-blue mb-1">안전 이상 유무</strong>
                    <p className="text-brand-blue/70 text-[14px] md:text-[15px] leading-relaxed break-keep">이동 중 보행 상태나 특별한 신체적 불편함은 없으셨는지 꼼꼼히 체크하여 알려드립니다.</p>
                  </div>
                </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-10">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed text-[14px] md:text-[15px] px-2">
